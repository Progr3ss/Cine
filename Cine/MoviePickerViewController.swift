...
//  Cine
//
//  Created by martin chibwe on 11/16/16.
...
extension MoviePickerViewController: UITableViewDelegate, UITableViewDataSource {
	...
	func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
		...
		//work on this crushing 
		navigationController!.pushViewController(controller, animated: true)
//		UITabBarController!.pushView
//		tabBarController!.pushViewController(controller, animated: true)
//		tabBarController?.popoverPresentationController(controller)
